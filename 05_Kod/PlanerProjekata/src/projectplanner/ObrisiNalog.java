...
public class ObrisiNalog extends javax.swing.JDialog {

    public ObrisiNalog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void bNeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bNeActionPerformed
        Administrator.obrisiNalog.setVisible(false);
    ...
    private void bDaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bDaActionPerformed
        Login.administrator.obrisiNalog();
